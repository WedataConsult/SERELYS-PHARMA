report 50100 "Posted Sales Invoice"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(TotalInvoiceDiscount; Header."Invoice Discount Amount")
            {
            }
            column(CompanyCity; companyinfo.City)
            {
            }
            column(CompanyCountry; CompanyInfoCountry.Name)
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    TotalAmountVATBase += "VAT Base Amount";
            ...
            begin
                ...
                if (Cust."Language Code" = 'FRA') or (Cust."Language Code" = '') then
                    CustLang := true
                ELSE
                    CustLang := false;
    ...
    begin
        ...
        CompanyInfo.Get();
        CompanyInfoCountry.get(CompanyInfo."Country/Region Code");
    ...
    var
        ...
        nfoCountry: Record "Country/Region";
